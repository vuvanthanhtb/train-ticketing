CREATE DATABASE IF NOT EXISTS train_ticketing DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

-- 1. ticket table
CREATE TABLE IF NOT EXISTS `train_ticketing`.`ticket` (
...
CREATE TABLE IF NOT EXISTS `train_ticketing`.`ticket_item` (
                                                               `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
